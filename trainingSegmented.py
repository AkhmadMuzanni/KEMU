# -*- coding: utf-8 -*-
"""
Created on Thu Sep 27 20:43:09 2018
...
np.seterr(all='warn')
Y = 1
with open('data/dataColorMoment.csv', 'a') as myfile:
    ...
    for filename in os.listdir("D:\\KULIAH\SEMESTER VII\\SKRIPSI - OFFLINE\\Ahmad Fauzi A _ Akhmad Muzanni S\\Segmentasi_All\\"):
        ...
        #strFile = 'D:\\KULIAH\\SEMESTER VII\\SKRIPSI - OFFLINE\\Ahmad Fauzi A _ Akhmad Muzanni S\\All\\001_0001_XiaomiRedmiNote4X.jpg'
            ...
            meanL, varL, skewL, kurtL = fw.getColorMoment(rgbImg[:,:,0])
            meanA, varA, skewA, kurtA = fw.getColorMoment(rgbImg[:,:,1])
            meanB, varB, skewB, kurtB = fw.getColorMoment(rgbImg[:,:,2])
